---
title: Fusklapp för V2 och BIFF
description: Kompakta svenska ordföljdsmallar för huvud- och bisats.
sidebar:
  label: V2 och BIFF
metaLanguage: sv
grammarLanguage: sv
...
”Position” betyder en satsdel. <span lang="sv">På måndag morgon</span> kan
fylla hela den första positionen.

## Negation i huvudsats

> subjekt + finit verb + <span lang="sv">inte</span> + …
...
beskrivning av varje svensk satstyp.
:::
